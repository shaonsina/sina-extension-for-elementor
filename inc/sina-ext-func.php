...
abstract class Sina_Ext_Functions extends Sina_Extension_Base{
	...
	public function widget_styles() {
		...
		wp_register_style( 'sina-tooltip', SINA_EXT_URL .'assets/css/sina-tooltip.min.css', [], SINA_EXT_PRO_VERSION );
	...
	public function widget_scripts() {
		...
		wp_register_script( 'sina-tooltip', SINA_EXT_URL .'assets/js/sina-tooltip.min.js', [], SINA_EXT_PRO_VERSION, true );
