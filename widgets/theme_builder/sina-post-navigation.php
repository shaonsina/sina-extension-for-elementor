...
class Sina_Post_Navigation_Widget extends Widget_Base{
	...
	protected function register_controls() {
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .sina-post-navigation span' => 'min-width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				Sina_Common_Data::link_style( $this, '.sina-post-navigation span', 'post_nav_btn' );
		...
		// ======================
			...
			Sina_Common_Data::link_style( $this, '.sina-post-nav-title', 'post_nav_title' );
			$this->end_controls_section();
		// End Nav Title Style
		// ====================
	}
