...
class Sina_Archive_Title_Widget extends Widget_Base{
	...
	protected function register_controls() {
		...
		// ==================
			...
			Sina_Common_Data::site_info( $this, '.sina-archive-title', 'archive_title' );
			$this->end_controls_section();
		// End Title Style
		// ================
	}
	...
	protected function render() {
		...
		?>
		<<?php echo sina_ext_escape_tags($data['html_tag']); ?> class="sina-archive-title"><?php the_archive_title( $data['before_text'], $data['after_text'] ); ?></<?php echo sina_ext_escape_tags($data['html_tag']); ?>>
		<?php
	}
