	...
	protected function register_controls() {
		...
		// ==================
			$this->start_controls_section(
				...
				Sina_Common_Data::link_style( $this, '.sina-dc-phone', 'phone_text' );
			$this->end_controls_section();
		// End Phone Style
		// ================
		...
		// =======================
			$this->start_controls_section(
				...
				Sina_Common_Data::icon_style( $this, '.sina-dc-phone i', 'phone_icon' );
			$this->end_controls_section();
		...
		// ==================
			$this->start_controls_section(
				...
				Sina_Common_Data::link_style( $this, '.sina-dc-email', 'email_text' );
			$this->end_controls_section();
		// End Email Style
		// ================
		...
		// =======================
			$this->start_controls_section(
				...
				Sina_Common_Data::icon_style( $this, '.sina-dc-email i', 'email_icon' );
			$this->end_controls_section();
