	...
	<div class="sina-bp-col <?php echo esc_attr( $columns.' sina-bp-'.$layout.' '.$thumb_float ); ?>">
		<div class="sina-bp">
			<?php if ( has_post_thumbnail() ): ?>
				<div class="sina-bg-thumb sina-bg-cover" style="background-image: url(<?php the_post_thumbnail_url(); ?>);">
					<div class="sina-overlay">
						<a href="<?php the_permalink(); ?>"></a>
					</div>
				</div>
			<?php endif; ?>
			<div class="sina-bp-content sina-flex">
				<div class="sina-bp-middle">
