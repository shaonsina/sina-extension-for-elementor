...
require_once( SINA_EXT_INC .'base-class.php' );
 ...
 * @since 2.3.2
 */
abstract class Sina_Settings extends Sina_Base {
	...
	public function settings_group() {
		...
		add_settings_field( 'sina_google_map_key', __('Google Map API Key', 'sina-ext'), [$this, 'map_api_key'], 'sina_ext_settings', 'sina_api_section' );
		add_settings_field( 'sina_mailchimp_key', __('MailChimp API Key', 'sina-ext'), [$this, 'mail_chimp_key'], 'sina_ext_settings', 'sina_api_section' );
		add_settings_field( 'sina_mailchimp_list_id', __('MailChimp List Id', 'sina-ext'), [$this, 'mail_chimp_list_id'], 'sina_ext_settings', 'sina_api_section' );

		$templates = get_option( 'sina_templates_option' );
		add_settings_section( 'sina_templates_section', '', '', 'sina_ext_templates' );
		add_settings_field( 'sina_ext_templates_only', __('Sina Templates', 'sina-ext'), [$this, 'templates_option'], 'sina_ext_templates', 'sina_templates_section', ['temps' => 'sina_templates_only', 'get_temps' => $templates] );
		add_settings_field( 'sina_ext_templates_merge', __('Sina Templates Merge', 'sina-ext'), [$this, 'templates_option'], 'sina_ext_templates', 'sina_templates_section', ['temps' => 'sina_templates_merge', 'get_temps' => $templates] );
